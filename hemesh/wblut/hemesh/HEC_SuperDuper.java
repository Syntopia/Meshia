...
public class HEC_SuperDuper extends HEC_Creator {
	...
	protected HE_Mesh createBase() {
		...
		final WB_Point3d[] points = getPoints();
	 ...
	 * @return the points
	 */
	private WB_Point3d[] getPoints() {
		final WB_Point3d[] m = new WB_Point3d[(U + 1) * (V + 1)];
	 ...
	 */
	private WB_Point3d eval(final double u, final double v) {
	 ...
	 * @return the w b_ point3d
	 */
	private WB_Point3d superduperformula(final double r0, double u, double v,
