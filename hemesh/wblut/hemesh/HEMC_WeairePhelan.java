...
public class HEMC_WeairePhelan extends HEMC_MultiCreator {
	...
	/** The Constant tetrakaidecahedronPoints. */
	...
	/**
	 * Instantiates a new hEM c_ weaire phelan.
	 */
	 ...
	 *
	 * @param p the p
	 * @return the hEM c_ weaire phelan
	 */
	 ...
	 * Sets the crop.
	 *
	 * @param cropU the crop u
	 * @param cropV the crop v
	 * @param cropW the crop w
	 * @return the hEM c_ weaire phelan
	 */
	 ...
	 * Sets the crop.
	 *
	 * @param cropUm the crop um
	 * @param cropVm the crop vm
	 * @param cropWm the crop wm
	 * @param cropUp the crop up
	 * @param cropVp the crop vp
	 * @param cropWp the crop wp
	 * @return the hEM c_ weaire phelan
	 */
