...
public class HE_Mesh extends HE_MeshStructure implements WB_HasData {
	 ...
	 *            the aabb
	 */
	public void fitInAABB(final WB_AABB3D AABB) {
		final WB_AABB3D self = getAABB();
	 ...
	 *            the aabb
	 */
	public double fitInAABBConstrained(final WB_AABB3D AABB) {
		final WB_AABB3D self = getAABB();
