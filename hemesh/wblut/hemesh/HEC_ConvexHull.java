...
public class HEC_ConvexHull extends HEC_Creator {
	...
	public HEC_ConvexHull setPoints(
			final Collection<? extends WB_Point3d> points) {

		this.points = new WB_Point3d[points.size()];
		final Iterator<? extends WB_Point3d> itr = points.iterator();
		int i = 0;
		while (itr.hasNext()) {
	...
	/**
	 * Gets the all faces visible to point.
	 * 
	 * @param mesh
	 *            the mesh
	 * @param p
	 *            the p
	 * @return the all faces visible to point
	 */
