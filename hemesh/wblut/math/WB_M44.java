...
public class WB_M44 {
	 ...
	 * Instantiates a new WB_M44.
	 *
	 * @param matrix44 double[4][4] values
	 */
	 ...
	 * @param m44 m44
	 */
	public WB_M44(final double m11, final double m12, final double m13,
	 ...
	 * Set values.
	 *
	 * @param matrix44 float[4][4] values
	 */
	 ...
	 */
	public WB_M44 get() {
		return new WB_M44(m11, m12, m13, m14, m21, m22, m23, m24, m31, m32,
	...
	public void multInto(final WB_M44 m, final WB_M44 result) {
		result.set(m11 * m.m11 + m12 * m.m21 + m13 * m.m31 + m14 * m.m41, m11
				* m.m12 + m12 * m.m22 + m13 * m.m32 + m14 * m.m42, m11 * m.m13
				+ m12 * m.m23 + m13 * m.m33 + m14 * m.m43, m11 * m.m14 + m12
				* m.m24 + m13 * m.m34 + m14 * m.m44, m21 * m.m11 + m22 * m.m21
				+ m23 * m.m31 + m24 * m.m41, m21 * m.m12 + m22 * m.m22 + m23
				* m.m32 + m24 * m.m42, m21 * m.m13 + m22 * m.m23 + m23 * m.m33
				+ m24 * m.m43, m21 * m.m14 + m22 * m.m24 + m23 * m.m34 + m24
				* m.m44, m31 * m.m11 + m32 * m.m21 + m33 * m.m31 + m34 * m.m41,
				m31 * m.m12 + m32 * m.m22 + m33 * m.m32 + m34 * m.m42, m31
						* m.m13 + m32 * m.m23 + m33 * m.m33 + m34 * m.m43, m31
						* m.m14 + m32 * m.m24 + m33 * m.m34 + m34 * m.m44, m41
						* m.m11 + m42 * m.m21 + m43 * m.m31 + m44 * m.m41, m41
						* m.m12 + m42 * m.m22 + m43 * m.m32 + m44 * m.m42, m41
	...
	public static WB_M44 mult(final WB_M44 n, final WB_M44 m) {
		return new WB_M44(n.m11 * m.m11 + n.m12 * m.m21 + n.m13 * m.m31 + n.m14
				* m.m41, n.m11 * m.m12 + n.m12 * m.m22 + n.m13 * m.m32 + n.m14
				* m.m42, n.m11 * m.m13 + n.m12 * m.m23 + n.m13 * m.m33 + n.m14
				* m.m43, n.m11 * m.m14 + n.m12 * m.m24 + n.m13 * m.m34 + n.m14
				* m.m44, n.m21 * m.m11 + n.m22 * m.m21 + n.m23 * m.m31 + n.m24
				* m.m41, n.m21 * m.m12 + n.m22 * m.m22 + n.m23 * m.m32 + n.m24
				* m.m42, n.m21 * m.m13 + n.m22 * m.m23 + n.m23 * m.m33 + n.m24
				* m.m43, n.m21 * m.m14 + n.m22 * m.m24 + n.m23 * m.m34 + n.m24
				* m.m44, n.m31 * m.m11 + n.m32 * m.m21 + n.m33 * m.m31 + n.m34
				* m.m41, n.m31 * m.m12 + n.m32 * m.m22 + n.m33 * m.m32 + n.m34
				* m.m42, n.m31 * m.m13 + n.m32 * m.m23 + n.m33 * m.m33 + n.m34
				* m.m43, n.m31 * m.m14 + n.m32 * m.m24 + n.m33 * m.m34 + n.m34
				* m.m44, n.m41 * m.m11 + n.m42 * m.m21 + n.m43 * m.m31 + n.m44
				* m.m41, n.m41 * m.m12 + n.m42 * m.m22 + n.m43 * m.m32 + n.m44
				* m.m42, n.m41 * m.m13 + n.m42 * m.m23 + n.m43 * m.m33 + n.m44
				* m.m43, n.m41 * m.m14 + n.m42 * m.m24 + n.m43 * m.m34 + n.m44
				* m.m44);
	}
	 ...
	 * @param result result
	 */
	public static void multInto(final WB_M44 n, final WB_M44 m,
			final WB_M44 result) {
		result.set(n.m11 * m.m11 + n.m12 * m.m21 + n.m13 * m.m31 + n.m14
				* m.m41, n.m11 * m.m12 + n.m12 * m.m22 + n.m13 * m.m32 + n.m14
				* m.m42, n.m11 * m.m13 + n.m12 * m.m23 + n.m13 * m.m33 + n.m14
				* m.m43, n.m11 * m.m14 + n.m12 * m.m24 + n.m13 * m.m34 + n.m14
				* m.m44, n.m21 * m.m11 + n.m22 * m.m21 + n.m23 * m.m31 + n.m24
	...
	public WB_M44 inverse() {
		final double[][] m = new double[][] { { m11, m12, m13, m14 },
		...
		for (int i = 0; i < 4; i++) {
			...
			for (int j = 0; j < 4; j++) {
				if (ipiv[j] != 1) {
					for (int k = 0; k < 4; k++) {
						if (ipiv[k] == 0) {
							if (WB_Fast.abs(minv[j][k]) >= big) {
								big = WB_Fast.abs(minv[j][k]);
								irow = j;
								icol = k;
							}
						} else if (ipiv[k] > 1) {
	...
	public WB_M44 getTranspose() {
		return new WB_M44(m11, m21, m31, m41, m12, m22, m32, m42, m13, m23,
	...
	public void transposeInto(final WB_M44 result) {
		result.set(m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43,
				m14, m24, m34, m44);
