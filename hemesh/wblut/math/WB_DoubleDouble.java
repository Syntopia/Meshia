...
public strictfp final class WB_DoubleDouble implements Serializable,
	 ...
	 */
	public static final WB_DoubleDouble PI = new WB_DoubleDouble(
			3.141592653589793116e+00, 1.224646799147353207e-16);

	/**
	 * The value nearest to the constant 2 * Pi.
	 */
	public static final WB_DoubleDouble TWO_PI = new WB_DoubleDouble(
			6.283185307179586232e+00, 2.449293598294706414e-16);

	/**
	 * The value nearest to the constant Pi / 2.
	 */
	public static final WB_DoubleDouble PI_2 = new WB_DoubleDouble(
			1.570796326794896558e+00, 6.123233995736766036e-17);

	/**
	 * The value nearest to the constant e (the natural logarithm base).
	 */
	public static final WB_DoubleDouble E = new WB_DoubleDouble(
	 ...
	 * valid number.
	 */
	public static final WB_DoubleDouble NaN = new WB_DoubleDouble(Double.NaN,
			Double.NaN);
	 ...
	 */
	public static WB_DoubleDouble valueOf(String str)
			throws NumberFormatException {
		return parse(str);
	}
	 ...
	 * @return the extended precision version of the value
	 */
	public static WB_DoubleDouble valueOf(double x) {
	 ...
	 */
	public WB_DoubleDouble(double x) {
		init(x);
	}
	 ...
	 *            the high-order component
	 */
	public WB_DoubleDouble(double hi, double lo) {
		init(hi, lo);
	}
	 ...
	 *            the value to initialize
	 */
	public WB_DoubleDouble(WB_DoubleDouble dd) {
		init(dd);
	}
	 ...
	 */
	public WB_DoubleDouble(String str) throws NumberFormatException {
		this(parse(str));
	}
	 ...
	 */
	public static WB_DoubleDouble copy(WB_DoubleDouble dd) {
	 ...
	 * @param dd the dd
	 */
	private void init(WB_DoubleDouble dd) {
		init(dd.hi, dd.lo);
	}
	 ...
	 * @return <tt>(this + y)</tt>
	 */
	public WB_DoubleDouble add(WB_DoubleDouble y) {
	 ...
	 * @return <tt>(this + y)</tt>
	 */
	public WB_DoubleDouble add(double y) {
		return copy(this).selfAdd(y);
	}
	 ...
	 */
	public WB_DoubleDouble selfAdd(WB_DoubleDouble y) {
	 ...
	 * @return this object, increased by y
	 */
	public WB_DoubleDouble selfAdd(double y) {
	 ...
	 * @return the w b_ double double
	 */
	private WB_DoubleDouble selfAdd(double yhi, double ylo) {
	 ...
	 * @return <tt>(this - y)</tt>
	 */
	public WB_DoubleDouble subtract(WB_DoubleDouble y) {
		return add(y.negate());
	}
	 ...
	 * @return <tt>(this - y)</tt>
	 */
	public WB_DoubleDouble subtract(double y) {
		return add(-y);
	}
	 ...
	 */
	public WB_DoubleDouble selfSubtract(WB_DoubleDouble y) {
		if (isNaN())
			return this;
		return selfAdd(-y.hi, -y.lo);
	}
	 ...
	 * @return this object, decreased by y
	 */
	public WB_DoubleDouble selfSubtract(double y) {
		if (isNaN())
			return this;
		return selfAdd(-y, 0.0);
	}
	 ...
	 * @return <tt>(this * y)</tt>
	 */
	public WB_DoubleDouble multiply(WB_DoubleDouble y) {
		if (y.isNaN())
			return createNaN();
	 ...
	 * @return <tt>(this * y)</tt>
	 */
	public WB_DoubleDouble multiply(double y) {
		if (Double.isNaN(y))
			return createNaN();
	 ...
	 */
	public WB_DoubleDouble selfMultiply(WB_DoubleDouble y) {
	 ...
	 * @return this object, multiplied by y
	 */
	public WB_DoubleDouble selfMultiply(double y) {
	 ...
	 * @return the w b_ double double
	 */
	private WB_DoubleDouble selfMultiply(double yhi, double ylo) {
	 ...
	 */
	public WB_DoubleDouble divide(WB_DoubleDouble y) {
	 ...
	 * @return a new object with the value <tt>(this / y)</tt>
	 */
	public WB_DoubleDouble divide(double y) {
		if (Double.isNaN(y))
			return createNaN();
	 ...
	 */
	public WB_DoubleDouble selfDivide(WB_DoubleDouble y) {
	 ...
	 * @return this object, divided by y
	 */
	public WB_DoubleDouble selfDivide(double y) {
	 ...
	 * @return the w b_ double double
	 */
	private WB_DoubleDouble selfDivide(double yhi, double ylo) {
		double hc, tc, hy, ty, C, c, U, u;
		C = hi / yhi;
		c = SPLIT * C;
		hc = c - C;
	...
	public WB_DoubleDouble rint() {
		...
		WB_DoubleDouble plus5 = this.add(0.5);
		return plus5.floor();
	}
	 ...
	 * @return the square of this value.
	 */
	public static WB_DoubleDouble sqr(double x) {
	...
	public WB_DoubleDouble sqrt() {
		...
		WB_DoubleDouble axdd = valueOf(ax);
		WB_DoubleDouble diffSq = this.subtract(axdd.sqr());
	 ...
	 * @return the w b_ double double
	 */
	public static WB_DoubleDouble sqrt(double x) {
	 ...
	 */
	public WB_DoubleDouble pow(int exp) {
		if (exp == 0.0)
			return valueOf(1.0);
	 ...
	 */
	public boolean equals(WB_DoubleDouble y) {
	 ...
	 * @return true if this value > y
	 */
	public boolean gt(WB_DoubleDouble y) {
	 ...
	 * @return true if this value >= y
	 */
	public boolean ge(WB_DoubleDouble y) {
		return (hi > y.hi) || (hi == y.hi && lo >= y.lo);
	}
	 ...
	 * @return true if this value < y
	 */
	public boolean lt(WB_DoubleDouble y) {
		return (hi < y.hi) || (hi == y.hi && lo < y.lo);
	}
	 ...
	 * @return true if this value <= y
	 */
	public boolean le(WB_DoubleDouble y) {
		return (hi < y.hi) || (hi == y.hi && lo <= y.lo);
	}
	...
	public int compareTo(Object o) {
		WB_DoubleDouble other = (WB_DoubleDouble) o;
	...
	private String extractSignificantDigits(boolean insertDecimalPoint,
		...
		WB_DoubleDouble scale = TEN.pow(mag);
		y = y.divide(scale);
	 ...
	 */
	public static WB_DoubleDouble parse(String str)
			throws NumberFormatException {
		int i = 0;
		...
		// scaling later
		WB_DoubleDouble val = new WB_DoubleDouble();
		...
		if (numDecPlaces == 0) {
			...
			WB_DoubleDouble scale = TEN.pow(numDecPlaces);
