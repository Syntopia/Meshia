...
public class WB_Voronoi2D {
	...
	private class VoronoiEdge2D {
		...
		/**
		 * Instantiates a new voronoi edge2 d.
		 */
		VoronoiEdge2D() {
	...
	private class VoronoiHalfedge2D {
		...
		/** The next halfedge in point queue. */
		VoronoiHalfedge2D	nextHalfedgeInPointQueue;

		/**
		 * Instantiates a new voronoi halfedge2 d.
		 */
		VoronoiHalfedge2D() {
	...
	/**
	 * Instantiates a new w b_ voronoi2 d.
	 */
	public WB_Voronoi2D() {
	}
	...
	/**
	 * Removes the halfedge from pointqueue.
	 *
	 * @param he the he
	 */
	...
	/**
	 * Checks if is point queue empty.
	 *
	 * @return true, if is point queue empty
	 */
	...
	/**
	 * Pop min from point queue.
	 *
	 * @return the voronoi halfedge2 d
	 */
	...
	/**
	 * Insert halfedge in edge list.
	 *
	 * @param lb the lb
	 * @param newHe the new he
	 */
	 ...
	 */
	/**
	 * Delete halfedge from edge list.
	 *
	 * @param he the he
	 */
	...
	/**
	 * Checks if is point to right of edge.
	 *
	 * @param el the el
	 * @param p the p
	 * @return true, if is point to right of edge
	 */
